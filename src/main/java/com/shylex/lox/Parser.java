...
public class Parser {
    ...
    private Stmt classDeclaration() {
        ...
        consume(LEFT_BRACE, "Expected '{' after class name declaration");
    ...
    private Stmt returnStatement() {
        ...
        Expr value = null;
        // If returning a value, store the next token as the value;
        if (!check(SEMICOLON)) {
            value = expression();
        }
    ...
    private Stmt.Function function(String kind) {
        ...
        // If there are parameters add them to the list
        if(!check(RIGHT_PAREN)) {
            do {
        ...
        consume(RIGHT_PAREN, "Expected ')' after function parameter definition.");
